...
bool ADXL345::getLinkBit() {
	return getRegisterBit(ADXL345_POWER_CTL, 5);
}

// If Set (1) sets link bit
// If Set (0) disables link bit
void ADXL345::setLinkBit(bool linkBit) {
	setRegisterBit(ADXL345_POWER_CTL, 5, linkBit);
}
